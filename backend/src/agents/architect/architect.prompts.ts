...
CRITICAL RULE FOR SUBSYSTEMS:
If the project requires complex communication protocols (such as I2S or SPI), audio output, or high-power actuators, you MUST explicitly include the necessary intermediate converter/driver/decoder ICs (e.g., I2S Audio DACs like MAX98357A, motor drivers like L298N/A4988, level shifters, transceiver modules) in the subsystems list so downstream agents source and wire them.
