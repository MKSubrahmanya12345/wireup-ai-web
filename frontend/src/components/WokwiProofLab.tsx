...
const EvidenceCard = ({ title, item, isDark }) => {
  ...
  return (
    <div className={`rounded-xl border p-4 ${isDark ? "border-white/10 bg-[#252525]" : "border-black/10 bg-white"}`}>
      ...
      {item.serialTail ? (
        <pre className={`mt-3 max-h-28 overflow-auto rounded-lg border p-2 text-[11px] leading-relaxed ${isDark ? "border-white/10 bg-[#1f1f1f] text-[#d9d9d9]" : "border-black/10 bg-[#f7f7f7] text-[#2d2d2d]"}`}>
          {item.serialTail}
        </pre>
      ) : null}
    </div>
...
export default function WokwiProofLab({ projectId, projectSnapshot, onProjectUpdate }) {
  ...
  return (
    <div className={`h-full overflow-y-auto px-5 py-5 ${isDark ? "bg-[#2d2d2d]" : "bg-[#fafafa]"}`}>
      <div className="grid gap-4 lg:grid-cols-2">
        <div className={`rounded-xl border p-4 ${isDark ? "border-white/10 bg-[#2a2a2a]" : "border-black/10 bg-white"}`}>
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            <button
              ...
              disabled={savingPath}
              className={`rounded-lg px-3 py-2 text-xs font-semibold ${isDark ? "bg-[#3a3a3a] hover:bg-[#4a4a4a]" : "bg-[#1a1a1a] text-white hover:bg-[#2d2d2d]"} ${savingPath ? "opacity-60" : ""}`}
            >
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            <button onClick={runLint} disabled={Boolean(runningAction)} className={`rounded-lg px-3 py-2 text-xs font-semibold ${isDark ? "bg-[#3a3a3a] hover:bg-[#4a4a4a]" : "bg-[#1a1a1a] text-white hover:bg-[#2d2d2d]"}`}>
              Lint
            </button>
            {/* Old broken code:
            <button onClick={runProject} disabled={Boolean(runningAction)} className={`rounded-lg px-3 py-2 text-xs font-semibold ${isDark ? "bg-[#3a3a3a] hover:bg-[#4a4a4a]" : "bg-[#1a1a1a] text-white hover:bg-[#2d2d2d]"}`}>
              Run
            </button>
            <button onClick={runScenario} disabled={Boolean(runningAction)} className={`rounded-lg px-3 py-2 text-xs font-semibold ${isDark ? "bg-[#3a3a3a] hover:bg-[#4a4a4a]" : "bg-[#1a1a1a] text-white hover:bg-[#2d2d2d]"}`}>
              Scenario
            </button>
            <button onClick={captureSerial} disabled={Boolean(runningAction)} className={`rounded-lg px-3 py-2 text-xs font-semibold ${isDark ? "bg-[#3a3a3a] hover:bg-[#4a4a4a]" : "bg-[#1a1a1a] text-white hover:bg-[#2d2d2d]"}`}>
              Serial Capture
            </button>
            */}
            {/* ??$$$ newer code */}
          ...
          <div className="mt-5 rounded-lg border p-3">
            ...
            <button
              ...
              className={`mt-3 rounded-lg px-3 py-2 text-xs font-semibold ${isDark ? "bg-[#3a3a3a] hover:bg-[#4a4a4a]" : "bg-[#1a1a1a] text-white hover:bg-[#2d2d2d]"} ${(!customChipName.trim() || Boolean(runningAction)) ? "opacity-60" : ""}`}
            >
        ...
        <div className={`rounded-xl border p-4 ${isDark ? "border-white/10 bg-[#2a2a2a]" : "border-black/10 bg-white"}`}>
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            {/* Old broken code:
            <button onClick={startMcpSession} disabled={Boolean(runningAction)} className={`rounded-lg px-3 py-2 text-xs font-semibold ${isDark ? "bg-[#3a3a3a] hover:bg-[#4a4a4a]" : "bg-[#1a1a1a] text-white hover:bg-[#2d2d2d]"}`}>
              Start MCP Session
            </button>
            */}
            {/* ??$$$ newer code */}
          ...
          {/* Old broken code:
          <button onClick={callMcpTool} disabled={Boolean(runningAction)} className={`mt-3 rounded-lg px-3 py-2 text-xs font-semibold ${isDark ? "bg-[#3a3a3a] hover:bg-[#4a4a4a]" : "bg-[#1a1a1a] text-white hover:bg-[#2d2d2d]"}`}>
            Call MCP Tool
          </button>
          */}
          {/* ??$$$ newer code */}
      ...
      <div className={`mt-4 rounded-xl border p-4 ${isDark ? "border-white/10 bg-[#2a2a2a]" : "border-black/10 bg-white"}`}>
        ...
        {/* Old broken code:
        <pre className={`mt-3 max-h-80 overflow-auto rounded-lg border p-3 text-[12px] leading-relaxed ${isDark ? "border-white/10 bg-[#1f1f1f] text-[#ddd]" : "border-black/10 bg-[#f7f7f7] text-[#2d2d2d]"}`}>
        */}
        {/* ??$$$ newer code */}
        <pre className={`mt-3 max-h-80 overflow-auto rounded-lg border p-3 text-[12px] leading-relaxed ${isDark ? "border-white/10 bg-[#1f1f1f] text-[#ddd]" : "border-black/10 bg-[#f7f7f7] text-[#2d2d2d]"}`}>
