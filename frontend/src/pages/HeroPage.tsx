...
export default function HeroPage() {
  ...
  return (
    <div className={`min-h-screen relative transition-colors duration-1000 ${isDark ? "bg-[#0a0c10] text-slate-200" : "bg-[#f8fafc] text-slate-900"}`}>
        ...
        <div className="mx-auto flex h-16 w-full max-w-7xl items-center justify-between px-8">
          ...
          <button
            ...
            className={`rounded-full px-6 py-2 text-[10px] font-black uppercase tracking-widest transition-all hover:scale-105 active:scale-95 ${
              isDark ? "bg-white text-[#1a1a1a] shadow-white/10" : "bg-slate-900 text-white shadow-slate-900/10"
            } shadow-xl`}
          >
      ...
      <main className="mx-auto max-w-7xl px-6 py-16 lg:py-24">
        ...
        <div className="grid gap-16 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
          ...
          >
            ...
            <p className={`mt-8 max-w-xl text-xl leading-relaxed ${isDark ? "text-slate-400" : "text-slate-600"}`}>
              Go from ideation to working prototype in minutes, not weekends. Just tell it what you want.
            </p>
        ...
        >
          <div className={`p-12 md:p-20 rounded-[38px] text-center ${isDark ? "bg-[#0a0c10]" : "bg-white"}`}>
            ...
            <button className="bg-white text-[#1a1a1a] px-12 py-5 rounded-2xl font-black text-lg shadow-2xl hover:bg-slate-100 transition-all">
              Sign up for Free
            </button>
